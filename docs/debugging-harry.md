# WL-Local-Server Feature Branch: debugging/Harry

## Description

This branch is about resolving several issues that arose and were found when running the synchronizer and MinIO scripts during the Spring 2025 semester for CSE 302/402.

## Key Changes

This feature introduces the following changes:

- Unique ID is generated for each MQTT client instance of the synchronizer.
