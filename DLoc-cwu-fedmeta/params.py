...
opt_exp.isTrain = True #type=bool, default=True, help='enables backpropogation, else the network is only used for evaluation')
...
opt_exp.gpu_ids = ['0'] #type=tuple of char, default=['1','2','3','0'], help='gpu ids: e.g. ['0']  ['0','1','2'], ['0','2']. CPU implementation is not supported. gpu_ids[0] is used for loading the network and the rest for DataParellilization')
...
opt_exp.lr = 1e-5
opt_exp.disjoint = True

opt_exp.batch_size = 16 #type=int, default=32, help='batch size for training and testing the network')
...
# opt_exp.save_name = '2024-03-14-22:06:28'
opt_exp.checkpoints_dir = join('/home/tahsin/Downloads/DLoc_code', opt_exp.save_name) # trained models are saved here
...
opt_encoder.lambda_cross = 1e-4 #type=float, default=1e-4, help='weight for cross entropy loss')
